...
This model could have been improved and other models could have been developed with different number of network layers, different vector quantization techniques, or different language models. But due to the limited time allocated for this thesis it was not possible to use other models.  
